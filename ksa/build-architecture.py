...
def build():
    ...
    p.append(arrow(420, 128, 420, 200, "candidates, employee master, Iqama expiry", ly=146, lx=436))
    p.append(arrow(700, 200, 700, 128, "Iqama number, expiry, profession back", ly=184, lx=684))
    ...
    p.append(box(300, 610, 520, 108, "b-fin", "SAP S/4HANA Finance &amp; Payroll",
                 ...
                 [["Journal posting to GL", "Levy accruals"]]))
    p.append(arrow(560, 496, 560, 610, "SADAD reference, VAT, GL account"))

    # ---- government portals, right ----
    p.append(box(880, 250, 228, 300, "b-gov", "Saudi platforms",
                 "The three that matter in KSA",
                 [["Qiwa (MHRSD)"], ["Muqeem (Iqama)"], ["Absher (MoI)"], ["GOSI · Mudad"], ["SCFHS · Mumaris+"]]))
    ...
    p.append('<text x="862" y="595" class="t-note">Qiwa and Muqeem grant access to</text>')
    p.append('<text x="862" y="611" class="t-note">the employer, not to a vendor.</text>')
