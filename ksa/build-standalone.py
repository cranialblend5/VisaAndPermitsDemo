...
SRC  = ROOT / "index.html"
OUT  = ROOT.parent / "site" / "ksa"
BASE = "https://cranialblend5.github.io/VisaAndPermitsDemo/ksa"

TITLE = "Visa &amp; Permits Management — Saudi Arabia"
DESC  = ("An interactive walkthrough of the INK IT Visa & Permits Management application "
         "on SAP BTP, configured for Saudi Arabia: Qiwa, Muqeem and Absher in step, Iqama "
         "lifecycle, exit and re-entry tracking, and live Nitaqat band position.")
...
<meta property="og:title" content="Visa &amp; Permits Management — Saudi Arabia">
...
<meta name="twitter:title" content="Visa &amp; Permits Management — Saudi Arabia">
...
def main() -> int:
    ...
    n = len(list((OUT / "web").glob("*")))
    kb = (OUT / "index.html").stat().st_size / 1024
    print(f"wrote site/ksa/index.html ({kb:.0f} KB) + {n} screens + brand + favicon")
    return 0
